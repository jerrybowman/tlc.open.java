...
public class X937ReturnAddendumCRecordImpl extends X937ReturnAddendumCRecordBase {
    ...
    private final Field[] localFieldCache = new Field[maxFieldNumber+1];
    ...
    private X937ReturnAddendumCRecord lengthOfImageArchiveSequenceNumber(String value) {
    ...
    private X937ReturnAddendumCRecord lengthOfImageArchiveSequenceNumber(int value) {
        setField(value, field(4));
        return this;
    }
