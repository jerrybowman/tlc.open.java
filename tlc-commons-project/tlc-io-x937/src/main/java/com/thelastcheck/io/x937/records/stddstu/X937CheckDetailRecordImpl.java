...
public class X937CheckDetailRecordImpl extends X937CheckDetailRecordBase {
    ...
    static {
        ...
        fields[13] = new Field("CheckDetailRecordAddendumCount", 13, 76, 2, FieldType.INT);
        fields[14] = new Field("CorrectionIndicator", 14, 78, 1, FieldType.STRING);
        fields[15] = new Field("ArchiveTypeIndicator", 15, 79, 1, FieldType.STRING);
    }
