...
public class X937CashLetterHeaderRecordImpl extends X937CashLetterHeaderRecordBase {
    ...
    static {
        ...
        fields[8] = new Field("CashLetterRecordTypeIndicator", 8, 42, 1, FieldType.STRING);
        fields[9] = new Field("CashLetterDocumentationTypeIndicator", 9, 43, 1, FieldType.STRING);
        ...
        fields[13] = new Field("FedWorkType", 13, 76, 1, FieldType.STRING);
        fields[14] = new Field("UserField", 14, 77, 2, FieldType.STRING);
        fields[15] = new Field("Reserved", 15, 79, 1, FieldType.STRING);
    }
