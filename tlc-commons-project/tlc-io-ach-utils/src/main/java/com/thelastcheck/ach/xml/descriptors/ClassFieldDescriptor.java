...
public class ClassFieldDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ClassFieldDescriptor() {
        ...
        //-- _items
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(ClassFieldItem.class, "_items", (String) null, org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ClassField target = (ClassField) object;
                    target.addClassFieldItem( (ClassFieldItem) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setClassDescriptor(new ClassFieldItemDescriptor());
