...
public class ClassDefinitionList implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<ClassDefinitionListItem> _items;
    ...
    public ClassDefinitionList() {
        super();
        this._items = new java.util.ArrayList<ClassDefinitionListItem>();
    }
    ...
    public void addClassDefinitionListItem(
            final ClassDefinitionListItem vClassDefinitionListItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ClassDefinitionListItem> enumerateClassDefinitionListItem(
    ) {
    ...
    throws IndexOutOfBoundsException {
        ...
        return (ClassDefinitionListItem) _items.get(index);
    }
    ...
    public ClassDefinitionListItem[] getClassDefinitionListItem(
        ...
        ClassDefinitionListItem[] array = new ClassDefinitionListItem[0];
        return (ClassDefinitionListItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends ClassDefinitionListItem> iterateClassDefinitionListItem(
    ) {
     ...
     */
    public ClassDefinitionListItem removeClassDefinitionListItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (ClassDefinitionListItem) obj;
    }
     ...
     */
    public void setClassDefinitionListItem(
            final ClassDefinitionListItem[] vClassDefinitionListItemArray) {
        //-- copy array
        _items.clear();
