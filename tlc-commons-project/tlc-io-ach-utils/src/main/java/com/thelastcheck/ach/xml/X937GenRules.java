...
public class X937GenRules implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<X937GenRulesItem> _items;
    ...
    public X937GenRules() {
        super();
        this._items = new java.util.ArrayList<X937GenRulesItem>();
    }
    ...
    public void addX937GenRulesItem(
            final X937GenRulesItem vX937GenRulesItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends X937GenRulesItem> enumerateX937GenRulesItem(
    ) {
    ...
    throws IndexOutOfBoundsException {
        ...
        return (X937GenRulesItem) _items.get(index);
    }
    ...
    public X937GenRulesItem[] getX937GenRulesItem(
        ...
        X937GenRulesItem[] array = new X937GenRulesItem[0];
        return (X937GenRulesItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends X937GenRulesItem> iterateX937GenRulesItem(
    ) {
     ...
     */
    public X937GenRulesItem removeX937GenRulesItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (X937GenRulesItem) obj;
    }
     ...
     */
    public void setX937GenRulesItem(
            final X937GenRulesItem[] vX937GenRulesItemArray) {
        //-- copy array
        _items.clear();
