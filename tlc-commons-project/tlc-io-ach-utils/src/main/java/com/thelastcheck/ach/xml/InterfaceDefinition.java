...
public class InterfaceDefinition implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<InterfaceDefinitionItem> _items;
    ...
    public InterfaceDefinition() {
        super();
        this._items = new java.util.ArrayList<InterfaceDefinitionItem>();
    }
    ...
    public void addInterfaceDefinitionItem(
            final InterfaceDefinitionItem vInterfaceDefinitionItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends InterfaceDefinitionItem> enumerateInterfaceDefinitionItem(
    ) {
     ...
     */
    public InterfaceDefinitionItem getInterfaceDefinitionItem(
            final int index)
    throws IndexOutOfBoundsException {
        ...
        return (InterfaceDefinitionItem) _items.get(index);
    }
    ...
    public InterfaceDefinitionItem[] getInterfaceDefinitionItem(
        ...
        InterfaceDefinitionItem[] array = new InterfaceDefinitionItem[0];
        return (InterfaceDefinitionItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends InterfaceDefinitionItem> iterateInterfaceDefinitionItem(
    ) {
     ...
     */
    public InterfaceDefinitionItem removeInterfaceDefinitionItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (InterfaceDefinitionItem) obj;
    }
     ...
     */
    public void setInterfaceDefinitionItem(
            final InterfaceDefinitionItem[] vInterfaceDefinitionItemArray) {
        //-- copy array
        _items.clear();
