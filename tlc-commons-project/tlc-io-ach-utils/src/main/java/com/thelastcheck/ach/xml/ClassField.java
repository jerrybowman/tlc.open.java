...
public class ClassField implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<ClassFieldItem> _items;
    ...
    public ClassField() {
        ...
        setSetter("public");
        setContent("");
        this._items = new java.util.ArrayList<ClassFieldItem>();
    }
    ...
    public void addClassFieldItem(
            final ClassFieldItem vClassFieldItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ClassFieldItem> enumerateClassFieldItem(
    ) {
     ...
     * the given index
     */
    public ClassFieldItem getClassFieldItem(
            final int index)
    throws IndexOutOfBoundsException {
        ...
        return (ClassFieldItem) _items.get(index);
    }
    ...
    public ClassFieldItem[] getClassFieldItem(
        ...
        ClassFieldItem[] array = new ClassFieldItem[0];
        return (ClassFieldItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends ClassFieldItem> iterateClassFieldItem(
    ) {
     ...
     */
    public ClassFieldItem removeClassFieldItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (ClassFieldItem) obj;
    }
     ...
     */
    public void setClassFieldItem(
            final ClassFieldItem[] vClassFieldItemArray) {
        //-- copy array
        _items.clear();
