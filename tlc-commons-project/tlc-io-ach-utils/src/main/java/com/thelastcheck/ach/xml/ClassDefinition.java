...
public class ClassDefinition implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<ClassDefinitionItem> _items;
    ...
    public ClassDefinition() {
        super();
        this._items = new java.util.ArrayList<ClassDefinitionItem>();
    }
    ...
    public void addClassDefinitionItem(
            final ClassDefinitionItem vClassDefinitionItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ClassDefinitionItem> enumerateClassDefinitionItem(
    ) {
    ...
    throws IndexOutOfBoundsException {
        ...
        return (ClassDefinitionItem) _items.get(index);
    }
    ...
    public ClassDefinitionItem[] getClassDefinitionItem(
        ...
        ClassDefinitionItem[] array = new ClassDefinitionItem[0];
        return (ClassDefinitionItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends ClassDefinitionItem> iterateClassDefinitionItem(
    ) {
     ...
     */
    public ClassDefinitionItem removeClassDefinitionItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (ClassDefinitionItem) obj;
    }
     ...
     */
    public void setClassDefinitionItem(
            final ClassDefinitionItem[] vClassDefinitionItemArray) {
        //-- copy array
        _items.clear();
