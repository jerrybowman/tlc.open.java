...
public class InterfaceDefinitionList implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<InterfaceDefinitionListItem> _items;
    ...
    public InterfaceDefinitionList() {
        super();
        this._items = new java.util.ArrayList<InterfaceDefinitionListItem>();
    }
    ...
    public void addInterfaceDefinitionListItem(
            final InterfaceDefinitionListItem vInterfaceDefinitionListItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends InterfaceDefinitionListItem> enumerateInterfaceDefinitionListItem(
    ) {
     ...
     * index
     */
    public InterfaceDefinitionListItem getInterfaceDefinitionListItem(
            final int index)
    throws IndexOutOfBoundsException {
        ...
        return (InterfaceDefinitionListItem) _items.get(index);
    }
    ...
    public InterfaceDefinitionListItem[] getInterfaceDefinitionListItem(
        ...
        InterfaceDefinitionListItem[] array = new InterfaceDefinitionListItem[0];
        return (InterfaceDefinitionListItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends InterfaceDefinitionListItem> iterateInterfaceDefinitionListItem(
    ) {
     ...
     */
    public InterfaceDefinitionListItem removeInterfaceDefinitionListItemAt(
            final int index) {
        Object obj = this._items.remove(index);
        return (InterfaceDefinitionListItem) obj;
    }
     ...
     */
    public void setInterfaceDefinitionListItem(
            final InterfaceDefinitionListItem[] vInterfaceDefinitionListItemArray) {
        //-- copy array
        _items.clear();
