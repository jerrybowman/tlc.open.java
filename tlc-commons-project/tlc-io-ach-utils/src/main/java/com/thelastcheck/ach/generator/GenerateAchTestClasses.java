...
public class GenerateAchTestClasses {
	private static Logger log = LoggerFactory.getLogger(GenerateAchTestClasses.class);
	...
	public static void main(String[] args) {
		GenerateAchTestClasses generator = new GenerateAchTestClasses();
