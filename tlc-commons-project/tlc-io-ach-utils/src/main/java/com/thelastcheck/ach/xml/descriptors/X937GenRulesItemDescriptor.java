...
public class X937GenRulesItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public X937GenRulesItemDescriptor() {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(InterfaceDefinitionList.class, "_interfaceDefinitionList", "interfaceDefinitionList", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    X937GenRulesItem target = (X937GenRulesItem) object;
                    target.setInterfaceDefinitionList( (InterfaceDefinitionList) value);
                } catch (Exception ex) {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(ClassDefinitionList.class, "_classDefinitionList", "classDefinitionList", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    X937GenRulesItem target = (X937GenRulesItem) object;
                    target.setClassDefinitionList( (ClassDefinitionList) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
