...
import com.thelastcheck.ach.xml.InterfaceField;
...
import com.thelastcheck.ach.xml.ClassFieldItem;

public class GenerateAchClasses {

    private static Logger log = LoggerFactory
            .getLogger(GenerateAchClasses.class);
    ...
    public static void main(String[] args) {
        GenerateAchClasses generator = new GenerateAchClasses();
        generator.run(args);
    }
    ...
    public void run(String[] args) {
        ...
        if (rulesFile == null) {
            rulesFile = "./src/main/resources/generated/genrules_ach_impl.xml";
        }
        if (sourceLocation == null) {
            sourceLocation = "./src/main/generated";
        }
        if (packageName == null) {
            packageName = "com.thelastcheck.io.ach";
        }
