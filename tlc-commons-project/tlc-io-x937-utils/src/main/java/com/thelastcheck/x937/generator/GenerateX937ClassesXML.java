...
public class GenerateX937ClassesXML {
	private static Logger log = LoggerFactory.getLogger(GenerateX937ClassesXML.class);
	...
	public static void main(String[] args) {
		new GenerateX937ClassesXML().run(args);
	}
	...
	private void run(String[] args) {
		...
		File xmlFile = new File(packageFileImpl, "genrules_x937_impl.xml");
		if (xmlFile.exists()) {
			xmlFile.delete();
		}
