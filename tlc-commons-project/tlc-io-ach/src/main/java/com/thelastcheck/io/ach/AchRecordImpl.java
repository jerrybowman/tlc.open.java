...
package com.thelastcheck.io.ach;
...
public abstract class AchRecordImpl extends RecordImpl implements AchRecord {
	 ...
	 * standard level.
	 */
	public AchRecordImpl() {
		this(0, ENCODING_EBCDIC, AchRecord.STANDARD_LEVEL_DSTU);
	}
	 ...
	 *            locations.
	 */
	public AchRecordImpl(int recordType, int stdLevel) {
	 ...
	 *            locations.
	 */
	public AchRecordImpl(int recordType, String encoding, int stdLevel) {
		super(80, encoding);
		clearRecord();
	 ...
	 *            locations.
	 */
	public AchRecordImpl(ByteArray record, int standardLevel) {
		super(record);
		initializeRecordType();
		if (recordType() == AchRecord.TYPE_FILE_HEADER) {
			try {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlc.io.x9.AchRecord#recordType()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlc.io.x9.AchRecord#recordType(int)
	 */
	public AchRecord recordType(int recordType) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlc.io.x9.AchRecord#recordStandardLevel()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.tlc.io.x9.AchRecord#recordStandardLevel(int)
	 */
	public AchRecord recordStandardLevel(int recordStandardLevel) {
